            ...
            <div className='center'>
                <Form class="centeredform" >
                    <Form.Group controlId="formFirstName">
                        ...
                        <Form.Control name="firstName" class="text_field" type="string" placeholder="Enter your first name" value={person.firstName} 
                        onChange={handleFirstNameChange}
                        required />
                    </Form.Group>
                    <Form.Group controlId="formLastName">
                        <Form.Label>Last Name</Form.Label>
                        <Form.Control name="lastName" class="text_field" type="string" placeholder="Enter your last lame" value={person.lastName} 
